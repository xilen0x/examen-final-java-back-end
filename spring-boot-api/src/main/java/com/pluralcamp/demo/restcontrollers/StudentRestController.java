...
public class StudentRestController {
	...
	@ResponseBody
	public ResponseEntity<Student> deleteStudent(@PathVariable int id) throws ResourceNotFoundException {
		//TODO
		Student student = this.studentService.deleteStudentById(id);
		return ResponseEntity.ok(student); //TO CHANGE
	}
